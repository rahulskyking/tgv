...
namespace TheGameVoice.Infrastructure.Migrations
{
    ...
    [Migration("20260909120000_AddSteamUrlToUser")]
    partial class AddSteamUrlToUser
    {
            ...
            modelBuilder.Entity("TheGameVoice.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasIndex("Segment", "Status", "PublishedAt")
                        .HasDatabaseName("ix_articles_segment_status_published_at");
                    ...
                    b.HasIndex("Status", "ScheduledPublishAt")
                        .HasDatabaseName("ix_articles_status_scheduled_publish_at");

                    b.HasIndex("Status", "ViewCount")
                        .HasDatabaseName("ix_articles_status_view_count");
            ...
            modelBuilder.Entity("TheGameVoice.Domain.Entities.Game", b =>
                {
                    ...
                    b.HasIndex("Segment")
                        .HasDatabaseName("ix_games_segment");
